  ...
  return (
    <li className="p-5 border-b-[0.001px] border-light-grayish-blue dark:border-dark-grayish-blue-2 flex item-center justify-between text-dark-grayish-blue-2 dark:bg-very-dark-desaturated-blue">
      <div className="flex item-center">
        <button type="check button" onClick={() => setComplated(!check)} className={`${check ? 'bg-check-background bg-cover' : 'border'} dark:border-dark-grayish-blue-2 flex items-center justify-center w-[20px] h-[20px] rounded-full me-2`}>
